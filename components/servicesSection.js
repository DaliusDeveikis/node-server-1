  ...
  const getServicesData = () => {
    return [
      ...
      },
      {
        ...
        title: 'Lakunas',
        description:
          'Time a digital asset donates a percentage of the fees back into the development of the asset through its charitable foundation.'
      },
      {
        icon: 'car',
        title: 'Taksistas',
        description:
          'Digital asset is purchased or sold, Sequoir donates a the development of the asset through its charitable foundation.'
      }
    ];
  };
